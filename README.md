## hri_rviz (jazzy) - 2.3.0-1

The packages in the `hri_rviz` repository were released into the `jazzy` distro by running `/home/severin/.local/bin/bloom-release --new-track --rosdistro jazzy --track jazzy hri_rviz` on `Mon, 09 Mar 2026 10:54:41 -0000`
...
## hri_rviz (rolling) - 2.3.0-1

The packages in the `hri_rviz` repository were released into the `rolling` distro by running `/home/severin/.local/bin/bloom-release --new-track --rosdistro rolling --track rolling hri_rviz` on `Mon, 09 Mar 2026 10:53:09 -0000`
